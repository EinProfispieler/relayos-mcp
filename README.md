...
Rendered prompts also guide agents to submit structured completion evidence via `write_handoff_result` after approved scoped execution. This remains guidance only, not automatic execution.
